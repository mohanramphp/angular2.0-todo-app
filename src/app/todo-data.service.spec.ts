...
describe('TodoDataService', () => {
  ...
  describe('#getAllTodos()',() => {
    ...
    it('should return all the added todos', inject([TodoDataService], (service: TodoDataService) => {
      let todoA = new Todo({
        title: 'todo 1',
        complete: false
      });
      ...
      service.addTodo(todoA);
      service.addTodo(todoB);
      expect(service.getAllTodos()).toEqual([todoA, todoB]);
    }));
